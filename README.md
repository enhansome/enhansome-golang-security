...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 506,623 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [gorilla/csrf](https://github.com/gorilla/csrf) ⭐ 1,211 | 🐛 37 | 🌐 Go | 📅 2025-04-14 - Provides Cross-Site Request Forgery (CSRF) prevention middleware for Go web applications & services.
...
* [gosec](https://github.com/securego/gosec) ⭐ 8,946 | 🐛 4 | 🌐 Go | 📅 2026-09-16 - Inspects source code for security problems by scanning the Go AST and matching it with a set of rules. Comes bundled in a Docker container [securego/gosec](https://hub.docker.com/r/securego/gosec).
...
* [CloudFlare SSL](https://github.com/cloudflare/cfssl) ⭐ 9,473 | 🐛 338 | 🌐 Go | 📅 2026-04-24 - CFSSL is CloudFlare's PKI/TLS swiss army knife. It is both a command line tool and an HTTP API server for signing, verifying, and bundling TLS certificates.
...
* [golang-tls](https://github.com/denji/golang-tls) ⭐ 1,329 | 🐛 4 | 📅 2020-11-20 - Simple Golang HTTPS/TLS Examples.
