...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 502,274 | 🐛 105 | 📅 2026-09-02 list thing.*
...
* [secure](https://github.com/unrolled/secure) ⭐ 2,355 | 🐛 0 | 🌐 Go | 📅 2026-05-01 -  Secure is an HTTP middleware for Go that facilitates most of your security needs for web applications.
* [nosurf](https://github.com/justinas/nosurf) ⭐ 1,750 | 🐛 16 | 🌐 Go | 📅 2025-05-13 - CSRF protection middleware for Go.
* [gorilla/csrf](https://github.com/gorilla/csrf) ⭐ 1,208 | 🐛 35 | 🌐 Go | 📅 2025-04-14 - Provides Cross-Site Request Forgery (CSRF) prevention middleware for Go web applications & services.
* [gorilla/securecookie](https://github.com/gorilla/securecookie) ⭐ 728 | 🐛 11 | 🌐 Go | 📅 2023-11-08 - Encodes and decodes authenticated and optionally encrypted cookie values for Go web applications.
...
* [httprobe](https://github.com/tomnomnom/httprobe) ⭐ 3,121 | 🐛 45 | 🌐 Go | 📅 2024-06-22 - Take a list of domains and probe for working HTTP and HTTPS servers.
...
* [gosec](https://github.com/securego/gosec) ⭐ 8,937 | 🐛 8 | 🌐 Go | 📅 2026-08-31 - Inspects source code for security problems by scanning the Go AST and matching it with a set of rules. Comes bundled in a Docker container [securego/gosec](https://hub.docker.com/r/securego/gosec).
...
* [CloudFlare SSL](https://github.com/cloudflare/cfssl) ⭐ 9,466 | 🐛 338 | 🌐 Go | 📅 2026-04-24 - CFSSL is CloudFlare's PKI/TLS swiss army knife. It is both a command line tool and an HTTP API server for signing, verifying, and bundling TLS certificates.
...
* [Lambhack](https://github.com/wickett/lambhack) ⭐ 97 | 🐛 1 | 🌐 Go | 📅 2019-10-07 - A very vulnerable serverless application in AWS Lambda.

## Articles, Guides & Talks

* [OWASP Go - Secure Coding Practices](https://github.com/OWASP/Go-SCP) ⭐ 5,289 | 🐛 26 | 🌐 Go | 📅 2024-05-31 by Checkmarx - Go programming language secure coding practices guide.
* [Hacking with Go](https://github.com/parsiya/Hacking-with-Go) ⚠️ Archived - Hacking with Go for security professionals.
* [golang-tls](https://github.com/denji/golang-tls) ⭐ 1,331 | 🐛 4 | 📅 2020-11-20 - Simple Golang HTTPS/TLS Examples.
