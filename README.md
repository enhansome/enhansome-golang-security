...
*List inspired by the [awesome](https://github.com/sindresorhus/awesome) ⭐ 507,042 | 🐛 106 | 📅 2026-09-02 list thing.*
...
* [httprobe](https://github.com/tomnomnom/httprobe) ⭐ 3,124 | 🐛 45 | 🌐 Go | 📅 2024-06-22 - Take a list of domains and probe for working HTTP and HTTPS servers.
...
* [gosec](https://github.com/securego/gosec) ⭐ 8,946 | 🐛 4 | 🌐 Go | 📅 2026-09-17 - Inspects source code for security problems by scanning the Go AST and matching it with a set of rules. Comes bundled in a Docker container [securego/gosec](https://hub.docker.com/r/securego/gosec).
